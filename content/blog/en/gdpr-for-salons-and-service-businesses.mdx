...
Operationally, you should be able to identify what information you hold about one person and why. That is much harder if records are split across a paper diary, phone, email and several spreadsheets than if they sit in one place in [client management](/en/client-management). See [Data rights](/en/data-rights) for the process used with Calendra.
