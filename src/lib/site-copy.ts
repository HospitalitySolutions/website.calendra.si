...
export const siteCopy = {
  ...
  en: {
    ...
    hero: {
      badge: "Smart. Simple. Efficient.",
      title1: "Simpler appointment management.",
      title2: "Perfect organisation.",
      description:
      ...
      reviewRating: "5/5 based on 20+ reviews",
      savedTimeValue: "6h+",
      savedTimeLabel: "Saved every week",
      savedTimeDetail: "through appointment automation",
      satisfactionValue: "98%",
      satisfactionLabel: "Client satisfaction",
      satisfactionDetail: "with the experience",
      appointmentsValue: "2,500+",
      appointmentsLabel: "Completed appointments",
      appointmentsDetail: "this month",
      screenshotAlt: "Weekly appointment calendar in the Calendra application",
    },
    features: {
      eyebrow: "Features",
