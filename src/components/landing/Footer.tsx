...
const footerLinks: Record<"sl" | "en", { product: FooterLink[]; features: FooterLink[]; support: FooterLink[]; legal: FooterLink[] }> = {
  sl: {
    ...
    features: [
      ...
      { key: "fiscalCashRegister", label: "Davčna blagajna" },
      { key: "groupBookings", label: "Skupinske rezervacije" },
  ...
  en: {
    ...
    features: [
      ...
      { key: "fiscalCashRegister", label: "Fiscal cash register" },
            ...
            <div className="mt-3 flex items-center gap-2">
              {socialLinks.map(({ label, href, Icon }) => (
                <a
                  ...
                  className="grid h-10 w-10 place-items-center rounded-xl border border-border bg-white text-muted-foreground shadow-sm transition hover:border-primary/30 hover:text-primary"
                >
